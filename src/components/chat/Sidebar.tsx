    ...
    <div className="w-full h-full bg-sidebar border-r border-sidebar-border flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="label-file text-[0.62rem] text-muted-foreground">En ligne</span>
              </div>
            </div>
          </div>
      ...
      <div className="p-2 flex gap-2 border-b border-sidebar-border">
        <Button
          variant="secondary"
          size="sm"
          className="flex-1 gap-1.5 label-file text-[0.62rem]"
          onClick={onNewChat}
        >
      ...
      <div className="flex-1 overflow-hidden">
        <div className="px-4 py-2">
          <h3 className="label-file text-[0.66rem] font-medium text-muted-foreground">
            Dossiers
          </h3>
        </div>
            ...
            {filteredConversations.length === 0 ? (
              ...
              filteredConversations.map((conv) => {
                ...
                return (
                  <div
                    key={conv.id}
                    className={`group w-full p-3 rounded-sm flex items-center gap-3 transition-colors cursor-pointer border-l-2 ${
                      isSelected
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-mono-ds text-[0.62rem] text-muted-foreground/70">
